class MalformedRequestException(Exception):  # noqa: N818
    def __init__(
        self,
        message,  # noqa: ANN001
    ) -> None:
...
class PermissionsFailedException(Exception):  # noqa: N818
    def __init__(
        self,
        message,  # noqa: ANN001
    ) -> None:
...
class MethodNotAllowedException(Exception):  # noqa: N818
    def __init__(
        self,
        message,  # noqa: ANN001
    ) -> None:
...
class ConflictException(Exception):  # noqa: N818
    def __init__(
        self,
        message,  # noqa: ANN001
    ) -> None:
