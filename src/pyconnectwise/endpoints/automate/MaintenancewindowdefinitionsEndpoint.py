...
from pyconnectwise.models.automate.Automate.Api.Domain.Contracts.Maintenance import (
...
class MaintenancewindowdefinitionsEndpoint(ConnectWiseEndpoint):
    def __init__(self, client, parent_endpoint=None):
        super().__init__(
            client, "Maintenancewindowdefinitions", parent_endpoint=parent_endpoint
        )
    ...
    ) -> list[MaintenanceWindowDefinition]:
        """
