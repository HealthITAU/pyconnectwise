...
class FinanceTaxCodesIdExpenseTypeExemptionsIdEndpoint(ConnectWiseEndpoint):
    def __init__(self, client, parent_endpoint=None):
        ...
        self.taxableExpenseTypeLevels = self._register_child_endpoint(
    ...
    def get(self, data: dict[str, Any] = {}, params: dict[str, int | str] = {}) -> ExpenseTypeExemptionModel:
        ...
        """
        return self._parse_one(ExpenseTypeExemptionModel, super()._make_request("GET", data=data, params=params).json())
    ...
    def put(self, data: dict[str, Any] = {}, params: dict[str, int | str] = {}) -> ExpenseTypeExemptionModel:
        ...
        Returns:
            ExpenseTypeExemptionModel: The parsed response data.
        """
        return self._parse_one(ExpenseTypeExemptionModel, super()._make_request("PUT", data=data, params=params).json())
    ...
    def patch(self, data: dict[str, Any] = {}, params: dict[str, int | str] = {}) -> ExpenseTypeExemptionModel:
        ...
        Returns:
            ExpenseTypeExemptionModel: The parsed response data.
        """
        return self._parse_one(ExpenseTypeExemptionModel, super()._make_request("PATCH", data=data, params=params).json())
