...
class ProcurementWarehouseBinsIdEndpoint(ConnectWiseEndpoint):
    def __init__(self, client, parent_endpoint=None):
        ...
        self.inventoryOnHand = self._register_child_endpoint(
    ...
    def get(self, data: dict[str, Any] = {}, params: dict[str, int | str] = {}) -> WarehouseBinModel:
        ...
        """
        return self._parse_one(WarehouseBinModel, super()._make_request("GET", data=data, params=params).json())
    ...
    def put(self, data: dict[str, Any] = {}, params: dict[str, int | str] = {}) -> WarehouseBinModel:
        ...
        Returns:
            WarehouseBinModel: The parsed response data.
        """
        return self._parse_one(WarehouseBinModel, super()._make_request("PUT", data=data, params=params).json())
    ...
    def patch(self, data: dict[str, Any] = {}, params: dict[str, int | str] = {}) -> WarehouseBinModel:
        ...
        Returns:
            WarehouseBinModel: The parsed response data.
        """
        return self._parse_one(WarehouseBinModel, super()._make_request("PATCH", data=data, params=params).json())
