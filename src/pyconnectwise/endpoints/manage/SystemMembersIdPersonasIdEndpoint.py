...
class SystemMembersIdPersonasIdEndpoint(
    ...
    def put(self, data: JSON | None = None, params: ConnectWiseManageRequestParams | None = None) -> MemberPersona:
        """
    ...
    def patch(self, data: PatchRequestData, params: ConnectWiseManageRequestParams | None = None) -> MemberPersona:
        """
